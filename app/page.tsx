...
const menuItems: MenuItem[] = [
  ...
  { id: 36, name: '綠茶', price: 20, category: '飲料', description: '中杯綠茶 (可選熱/冰)' },
  { id: 37, name: '梅子綠', price: 25, category: '飲料', description: '中杯梅子綠茶 (可選熱/冰)' },
  { id: 38, name: '阿華田', price: 35, category: '飲料', description: '中杯阿華田 (可選熱/冰)' },
  { id: 39, name: '多多綠', price: 30, category: '飲料', description: '中杯多多綠茶 (可選熱/冰)' },
  { id: 40, name: '多多檸檬', price: 30, category: '飲料', description: '中杯多多檸檬 (可選熱/冰)' },
  { id: 41, name: '冬瓜茶', price: 20, category: '飲料', description: '中杯冬瓜茶 (可選熱/冰)' },
  { id: 42, name: '冬瓜綠', price: 25, category: '飲料', description: '中杯冬瓜綠茶 (可選熱/冰)' },
  { id: 43, name: '冬瓜紅', price: 25, category: '飲料', description: '中杯冬瓜紅茶 (可選熱/冰)' },
  { id: 44, name: '鮮奶綠', price: 35, category: '飲料', description: '中杯鮮奶綠茶 (可選熱/冰)' },
  { id: 45, name: '冬瓜檸檬', price: 25, category: '飲料', description: '中杯冬瓜檸檬 (可選熱/冰)' },
  { id: 46, name: '薄荷綠', price: 25, category: '飲料', description: '中杯薄荷綠茶 (可選熱/冰)' },
  { id: 47, name: '蜜茶', price: 25, category: '飲料', description: '中杯蜜茶 (可選熱/冰)' },
  { id: 48, name: '奶茶', price: 25, category: '飲料', description: '中杯奶茶 (可選熱/冰)' },
  { id: 49, name: '椰果奶茶', price: 30, category: '飲料', description: '中杯椰果奶茶 (可選熱/冰)' },
